						...
						<div className="formgrid grid">
							<div className="field col">
								...
								<InputText
									...
									onChange={(e) => onInputChange(e, "nom_equ")}
									required
									autoFocus
									className={classNames({
										"p-invalid": submitted && !formData.nom_equ,
									})}
								/>
						...
						<div className="formgrid grid">
							<div className="field col">
								...
								<InputText
									...
									onChange={(e) => onInputChange(e, "car_equ")}
								/>
							</div>
							<div className="field col">
								<label htmlFor="car_equ_ing">Cargo ingles:</label>
								<InputText
									id="car_equ_ing"
									value={formData.car_equ_ing}
									onChange={(e) => onInputChange(e, "car_equ_ing")}
								/>
							</div>
						</div>
